...
public class LinkedIntListExercise15
{
...
// and methods for add and toString.
    ...
    public LinkedIntListExercise15()
    {
        front = null;
    }
    ...
    public int max(LinkedIntListExercise15 list)
    {
        if (front == null)
        {
    ...
    //Metode til opgave 9
    public LinkedIntListExercise15 stutter()
    {
        int value = 0;
        LinkedIntListExercise15 theList = new LinkedIntListExercise15();
        ListNode current = front;
    ...
    //Metode til opgave 15
    public boolean notEquals(LinkedIntListExercise15 theList)
    {
        boolean tempBoolean = false;
        ListNode current = front;
        ListNode tempListNode = theList.front;

        while (current != null)
        {
            if (current.next.equals(tempListNode.next))
            {
                tempBoolean = true;
            }
            current = current.next;
